    ...
    */
    ...
    app.run(['$rootScope','$httpBackend','speakerDataModelService','speakerDataModelUrlService',
        ...
        var initUrlMocksAll = function () {
            ...
            var accountLoginUrl = "/rpc/account/login";
            $httpBackend.whenPOST(accountLoginUrl).respond(function (method, url, data) {
                var accountInfo = {
                    "returnStatus": "OK",
                    "codeCampType": "svcc",
                    "registrationWords": "To attend Angular University you <b>must be registered and have a confirmed ticket</b>.",
            ...
            var accountLogoutUrl = "/rpc/account/LogOut";
            $httpBackend.whenPOST(accountLogoutUrl).respond(function (method, url, data) {
                return [200, {}, {}];
            });
