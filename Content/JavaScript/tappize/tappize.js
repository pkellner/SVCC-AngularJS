(function ($) {
    ...
    var TappizeMenus = {
        init: function( $subMenuSelector ) {
            if (jQuery.browser.mobile) {
                $subMenuSelector.closest('li').on('click', function(e) {
                    TappizeMenus.tappize( $(this), $(this).siblings(), e );
                });
            }
        },
         ...
         */
        tappize: function( $current_element, $sibling_elements, event ) {
            if (!$current_element.hasClass('hover')) {
                $sibling_elements.removeClass('hover');
    ...
    $.fn.tappizeMenus = function () {
        TappizeMenus.init(this);
        return this;
    };
}(jQuery));
